...
### Data collection mode :
 When running the car in training mode, a human driver controls the car driving around the track. This human dri
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI0MTQ5NDIsLTEwNDgwODE0OV19
-->