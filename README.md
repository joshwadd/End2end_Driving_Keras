...
The Udacity simulator contains two separate tracks that differ in both difficulty and visual properties of the environment.  For both tracks the car can be operated in either data collection mode or autonomous control mods
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzAyODEyODIsLTEwNDgwODE0OV19
-->