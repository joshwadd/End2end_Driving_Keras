...
Once this data has been collected from the driving simulator, the camera images are used as an input to the model  which attempts to predict the steering angle for the corresponding input




<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMyMTkxMDgwMCwtNDAyNTQxNjIyLC0xMD
Q4MDgxNDldfQ==
-->