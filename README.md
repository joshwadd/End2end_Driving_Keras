...
### Data collection mode :
 When running the car in training mode, a human driver controls the car driving around the track. This human driving behaviour is captured
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjEzOTI3MDMsLTEwNDgwODE0OV19
-->