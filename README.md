...
### Data collection mode :
 When running the car in training mode, a human driver controls the car driving around the track and the simulator 
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEwODMwMTgsLTEwNDgwODE0OV19
-->