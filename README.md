...
The car is equipped with three front facing cameras recording images from the left, centre and right views of the front facing driving view of the car at each time-step.  The driving simulator then saves frames from the three cameras alongside various 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYzMDgyMzM1MiwtNDAyNTQxNjIyLC0xMD
Q4MDgxNDldfQ==
-->