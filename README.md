...
### Data collection mode :
 When running the car in training mode, a human driver controls the car driving around the track. This human dir
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAxNzk5MDg0LC0xMDQ4MDgxNDldfQ==
-->