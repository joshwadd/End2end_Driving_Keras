...
To prevent the CNN architecture from over-fitting to the training data set and to increase the ability of the model generalisation  


<!--stackedit_data:
eyJoaXN0b3J5IjpbNTEzNTQ0NzgyLC00MDI1NDE2MjIsLTEwND
gwODE0OV19
-->