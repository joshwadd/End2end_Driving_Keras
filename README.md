...
The Udacity simulator contains two separate tracks that differ in both difficulty and visual properties of the environment. On both tracks the simulated autonomous car can be operated in either training mode for data collection, or 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzQxODc1OTcsLTEwNDgwODE0OV19
-->