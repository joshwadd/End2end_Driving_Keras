...
Once this data has been collected from the driving simulator, the camera inputs are used as an input to t




<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1MTkzMjc0MCwtNDAyNTQxNjIyLC0xMD
Q4MDgxNDldfQ==
-->