...
The data augmentation pipeline was implemented as a generator function in python. Keras allows the use of generator functions to be used heterogeneous manner on the CPU
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMDg4MzA2OTksMzMwMzQ1MjY4LC00MD
