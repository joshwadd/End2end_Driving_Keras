...
| `model.h5`                 | Model weights saved in Hierarchical Data Format JSON file containing model architecture in a format Keras understands.             |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyOTY2NjQ0OCwtMTA0ODA4MTQ5XX0=
-->